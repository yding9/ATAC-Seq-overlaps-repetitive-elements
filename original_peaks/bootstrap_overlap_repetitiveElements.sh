## This script only outputs the number of lines in the overlapping files. Use bootstrap_overlap_RepeatElement_percentage.sh.
# ls | grep -v top9832
...
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_repeatMaskerintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.LINE.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_LINEintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.LTR.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_LTRintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.Satellite.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_Satelliteintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.Simple_repeat.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_SimpleRepeatintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.SINE.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_SINEintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.DNA_Transposon.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_DNATransposonintsxns100xCounts.txt;
done
done
...
intersectBed -wa -u -a temp -b ../reference/hg38.repeatMasker.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_shuffled_repeatMaskerintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.LINE.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_shuffled_LINEintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.LTR.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_shuffled_LTRintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.Satellite.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_shuffled_Satelliteintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.Simple_repeat.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_shuffled_SimpleRepeatintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.SINE.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_shuffled_SINEintsxns100xCounts.txt;
intersectBed -wa -u -a temp -b ../reference/hg38.DNA_Transposon.bed > temp2;
wc -l temp2 | cut -f1 -d " " >> "${i/.bed5/}"_shuffled_DNATransposonintsxns100xCounts.txt;
done
done
